...
interface ProfissionaisErrorStateProps {
  titulo: string;
  mensagem: string;
}

/** Mesmo padrão visual de AgendaErrorState/ClientesErrorState/ServicosErrorState. */
export function ProfissionaisErrorState({ titulo, mensagem }: ProfissionaisErrorStateProps) {
  return (

...
interface ProfissionaisEmptyStateProps {
  titulo: string;
  descricao: string;
}

/** Mesmo padrão visual do estado vazio de Clientes/Serviços/Agenda — card tracejado, sem erro. */
export function ProfissionaisEmptyState({ titulo, descricao }: ProfissionaisEmptyStateProps) {
  return (

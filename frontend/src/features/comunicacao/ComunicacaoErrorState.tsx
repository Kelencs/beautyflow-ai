...
interface ComunicacaoErrorStateProps {
  titulo: string;
  mensagem: string;
}

/** Mesmo padrão visual de FinanceiroErrorState/ServicosErrorState — consistência entre módulos. */
export function ComunicacaoErrorState({ titulo, mensagem }: ComunicacaoErrorStateProps) {
  return (

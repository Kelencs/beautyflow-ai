...
/** Mesmo padrão visual de AgendaErrorState/ClientesErrorState/ServicosErrorState/ProfissionaisErrorState. */
export function DashboardErrorState({ titulo, mensagem }: DashboardErrorStateProps) {
  return (

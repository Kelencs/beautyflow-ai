...
interface ServicosErrorStateProps {
  titulo: string;
  mensagem: string;
}

/** Mesmo padrão visual de AgendaErrorState/ClientesErrorState — consistência entre módulos. */
export function ServicosErrorState({ titulo, mensagem }: ServicosErrorStateProps) {
  return (
